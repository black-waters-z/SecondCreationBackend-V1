...
class Draft(models.Model):
    ...
    poster = fields.ForeignKeyField("models.User", related_name="drafts", on_delete=CASCADE)  # related_name 反向查询
    zones = fields.ManyToManyField("models.Zone", related_name="drafts")
